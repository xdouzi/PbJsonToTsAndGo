...
func NewPbToGoMain() *PbToGoMain {
	t := &PbToGoMain{}
	return t
}
func (t *PbToGoMain) CheckToTime() bool {
	return false
}

func (t *PbToGoMain) Hang() {

}

func (t *PbToGoMain) DeleteFiles(output string, s string) {

}

func (t *PbToGoMain) Start(dirPath string) {
	// 检查文件夹是否存在
